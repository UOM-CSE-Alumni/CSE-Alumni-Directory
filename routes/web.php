...
Route::post('user/profile/update', 'UserController@updateUserProfileView')->name('update_user_profile');
Route::get('user/viewUserProfile/{id}', 'UserController@viewProfile');
